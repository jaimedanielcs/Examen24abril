    ...
    <ol class="property-list articulo">
        ...
        <g:if test="${articuloInstance?.fabricas}">
            <li class="fieldcontain">
                <span id="fabricas-label" class="property-label"><g:message code="articulo.fabricas.label"
                                                                            default="Fabricas"/></span>

                <g:each in="${articuloInstance.fabricas}" var="f">
                    <span class="property-value" aria-labelledby="fabricas-label"><g:link controller="fabrica"
                                                                                          action="show"
